...
const L = {
  full:   window.__resources.lockupColor,
  navy:   window.__resources.lockupNavy,
  orange: window.__resources.lockupOrange,
  white:  window.__resources.lockupWhite,
  stacked: window.__resources.lockupStacked,
  stackedWhite: window.__resources.lockupStackedWhite,
};
const M = {
  full:   window.__resources.markColor,
  navy:   window.__resources.markNavy,
  orange: window.__resources.markOrange,
  white:  window.__resources.markWhite,
  amber:  window.__resources.markAmber,
};
